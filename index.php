...
<head>
    ...
    <title>Fedaration Banking</title>
    <style type="text/css">
        button{
            position: relative;
  ...
  ?>
    ...
    <div class="container-fluid">
        ...
        <div class="intro py-1">
            <div >
                <div >
                   <center> <h1>Welcome to fedaration Banking System</h1></center>
                </div>
            </div>
        ...
        <div class="row activity text-center">
            ...
            <div class="col-md act">
                <br><br>
                <img src="img/OIP.jpg" class="img-fluid">
                <br><br>
    ...
    <footer class="text-center mt-5 py-2">
        <p>&copy 2021. Made by <b>Bhavi teja</b> <br> For the Project of  <b>The Sparks Foundation</b></p>
    </footer>
